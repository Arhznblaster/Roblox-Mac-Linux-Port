...
namespace DarlingServer {
	...
	public:
		...
		// Send immediately from the calling thread when nothing is queued ahead
		// of the message; otherwise (or when the socket is full) queue it.
		void pushOrSend(int socket, Message&& message);

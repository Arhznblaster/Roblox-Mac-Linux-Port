...
public:
	...
	const CAStreamBasicDescription& GetStreamFormat(AudioUnitScope scope, AudioUnitElement element) override;
	OSStatus Version() override;
 bool ValidFormat(AudioUnitScope,AudioUnitElement,const CAStreamBasicDescription&) override;
 UInt32 GetChannelLayoutTags(AudioUnitScope,AudioUnitElement,AudioChannelLayoutTag*) override;
 UInt32 GetAudioChannelLayout(AudioUnitScope,AudioUnitElement,AudioChannelLayout*,Boolean&) override;
 OSStatus SetAudioChannelLayout(AudioUnitScope,AudioUnitElement,const AudioChannelLayout*) override;

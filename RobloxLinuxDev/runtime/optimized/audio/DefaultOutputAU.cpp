...
: AUHAL(inInstance)
{
 // Internal default proxies connect with a null Pulse target (server policy).
 m_outputDevice=kAudioObjectSystemObject+1;
 m_inputDevice=kAudioObjectSystemObject+2;
}
